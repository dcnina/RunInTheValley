...
//                 menuBackground.getButtons()[0].mouseHover(v);
//                 if(menuBackground.getButtons()[0].mouseHover(v)){
//                     //std::cout << "Hover button Score"<<std::endl;
//                 }
//                 else if(menuBackground.getButtons()[1].mouseHover(v)){
//                     //std::cout << "Hover button Play"<<std::endl;
//                 }
//                 else if(menuBackground.getButtons()[2].mouseHover(v)){
